---
name: ship-it
description: Create a PR, request code reviews from bots (Claude and Gemini), address all review comments, and merge. Use this when the user is ready to ship their current branch.
---
